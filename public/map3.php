...
<div class="container-fluid gridHolder">
    <div class="row" id="toto">
        ...
        <div class="col zones" id="45"><img class="bonbons" id="b45" src="assets/images/reglisse.png" alt=""></div>
    ...
    <div class="row">
        <div class="col zones" id="20"><img class="bonbons" id="b20" src="assets/images/bonbonzizi.png" alt=""></div>
        <div class="col zones" id="21"></div>
        <div class="col zones" id="22"></div>
        <div class="col zones" id="23"><img class="bonbons" id="b23" src="assets/images/ours.png" alt=""></div>
        <div class="col zones" id="24"></div>
        <div class="col zones" id="25"><img class="bonbons" id="b25" src="assets/images/bonbonzizi.png" alt=""></div>
        <div class="col zones" id="26"><img class="bonbons" id="b26" src="assets/images/skittles.png" alt=""></div>
    </div>
    <div class="row">
