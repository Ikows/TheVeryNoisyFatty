...
<div class="container-fluid gridHolder">
    ...
    <div class="row">
        <div class="col zones" id="30"><img class="bonbons" id="b34" src="assets/images/dragibus.png" alt=""></div>
        <div class="col zones" id="31"></div>
        <div class="col zones" id="32"><img class="bonbons" id="b34" src="assets/images/bonbonzizi.png" alt=""></div>
        ...
        <div class="col zones" id="36"><img class="bonbons legumes" id="b34" src="assets/images/courgette.png" alt=""></div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col zones" id="10"><img class="bonbons legumes" id="b34" src="assets/images/chou.png" alt=""></div>
        <div class="col zones" id="11"></div>
        <div class="col zones" id="12"></div>
        <div class="col zones" id="13"><img class="bonbons" id="b34" src="assets/images/reglisse.png" alt=""></div>
        <div class="col zones" id="14"></div>
        <div class="col zones" id="15"><img class="bonbons" id="b34" src="assets/images/ours.png" alt=""></div>
    ...
    <div class="row">
        ...
        <div class="col zones" id="4"><img class="bonbons" id="b34" src="assets/images/skittles.png" alt=""></div>
        <div class="col zones" id="5"></div>
        <div class="col zones" id="6"><img class="bonbons legumes" id="b34" src="assets/images/brocoli.png" alt=""></div>
    </div>


</div>
<div><a href="map2.php" role="button" class="btn-lg" id="next">Aller au niveau 2</a></div>
