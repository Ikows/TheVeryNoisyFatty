...
<div class="container-fluid gridHolder">
    <div class="row" id="toto">
        ...
        <div class="col zones" id="45"></div>
        <div class="col zones" id="46"></div>
    </div>
    <div class="row">
        <div class="col zones" id="30"><img class="bonbons" id="b34" src="assets/images/bonbonzizi.png" alt=""></div>
        <div class="col zones" id="31"><img class="bonbons" id="b34" src="assets/images/bonbonzizi.png" alt=""></div>
        <div class="col zones" id="32"><img class="bonbons" id="b34" src="assets/images/bonbonzizi.png" alt=""></div>
        <div class="col zones" id="33"><img class="bonbons" id="b34" src="assets/images/bonbonzizi.png" alt=""></div>
    ...
    <div class="row">
        ...
        <div class="col zones" id="21"><img class="bonbons" id="b21" src="assets/images/bonbonzizi.png" alt=""></div>
        <div class="col zones" id="22"></div>
        <div class="col zones" id="23"><img class="bonbons" id="b34" src="assets/images/bonbonzizi.png" alt=""></div>
        <div class="col zones" id="24"><img class="bonbons" id="b34" src="assets/images/schokobon.png" alt=""></div>
        <div class="col zones" id="25"><img class="bonbons" id="b34" src="assets/images/bonbonzizi.png" alt=""></div>
...
<div><a href="map4.php" role="button" class="btn-lg" id="next">Aller au niveau 4</a></div>
